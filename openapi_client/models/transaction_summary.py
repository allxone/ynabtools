...
class TransactionSummary(BaseModel):
    ...
    id: StrictStr
    var_date: date = Field(
        description="The transaction date in ISO format (e.g. 2016-12-01)", alias="date"
    )
    ...
    def debt_transaction_type_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('payment', 'refund', 'fee', 'interest', 'escrow', 'balanceAdjustment', 'credit', 'charge')"
            )
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.transfer_account_id is None
            and "transfer_account_id" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.transfer_transaction_id is None
            and "transfer_transaction_id" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.matched_transaction_id is None
            and "matched_transaction_id" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.import_payee_name is None
            and "import_payee_name" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.import_payee_name_original is None
            and "import_payee_name_original" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.debt_transaction_type is None
            and "debt_transaction_type" in self.model_fields_set
        ):
